...
class ADKHostManagerTest(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.conversationid = 'test_conversation'
    ...
    def test_adk_content_to_message_file(self):
        ...
        self.assertEqual(
            message.metadata['conversationid'], self.conversationid
        )
    ...
    def test_adk_content_to_message_unknown_type(self):
        ...
        with self.assertRaisesRegex(
            ...
            self.manager.adk_content_to_message(content, self.conversationid)
